/* BigCommunity welcome page for Calamares welcomeq. */
    ...
    contentItem: Item {
        ...
        ColumnLayout {
            ...
            Item {
                ...
                Image {
                    anchors.centerIn: parent
                    // The illustration is 560x280 and reads on both a light
                    // and a dark window, so it needs no per-theme variant;
                    // the height follows its own 2:1 ratio.
                    width: artwork.span * 0.62
                    height: width * 0.5
                    source: "welcome-illustration.svg"
                    sourceSize.width: width
                    sourceSize.height: height
                    fillMode: Image.PreserveAspectFit
                    smooth: true
