...
Rectangle {
    ...
    readonly property color panelBackground: "#1E2936"
    readonly property color panelBorder: Qt.rgba(1, 1, 1, 0.10)
    readonly property color trackDone: "#22D3EE"
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Label {
                Layout.alignment: Qt.AlignHCenter
                Layout.topMargin: 12
                // Shown without the scheme, and read from the branding so it
                // never drifts from productUrl.
                text: Branding.string(Branding.ProductUrl)
                    .replace(/^https?:\/\//, "")
