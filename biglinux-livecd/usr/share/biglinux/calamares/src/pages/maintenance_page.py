...
class MaintenancePage(Gtk.Box):
    ...
    def _create_option_card(
        ...
        desc_box = self._create_description_box(description, description2)
    ...
    @staticmethod
    def _create_description_box(description, description2=None):
        desc_box = Gtk.Box(
            orientation=Gtk.Orientation.VERTICAL,
            spacing=4,
            vexpand=True,
    ...
    def create_content(self):
        ...
        restore_card = self._create_option_card(
            ...
            description=_(
                "Utility that facilitates the restoration of the installed system, especially the restoration of the system boot (Grub).\n\nIt can also be used to access the package manager and terminal of the installed system."
            ),
            button_text=_("Start"),
        ...
        if self.system_service.can_manage_efi_entries():
            efi_card = self._create_option_card(
                ...
                description=_(
                    "Advanced tool to add, remove, or change boot entries in the UEFI firmware."
                ),
                button_text=_("Start"),
                button_style="secondary",
